...
const PREGNANCY_TIPS = [
  {
    ...
    category: "Nutrition",
    title: "Stay Hydrated",
    content: `Drinking plenty of water is essential during pregnancy. It helps maintain amniotic fluid levels, prevents constipation, and helps the body cope with the demands of pregnancy.`,
  ...
  },
  {
    ...
    content: `Focus on a balanced diet rich in fruits, vegetables, lean proteins, and whole grains. These provide essential nutrients for both you and your baby's development.`,
    benefits: "Mother and Baby",
  ...
  },
  {
    ...
    content: `Staying active during pregnancy can help reduce discomfort, improve mood, and promote better sleep. Choose activities like walking, swimming, or prenatal yoga that are safe for pregnancy.`,
    benefits: "Mother",
  ...
  },
  {
    ...
    content: `Prenatal vitamins supplement your diet with essential nutrients like folic acid, iron, and calcium, which are crucial for your baby's development. Consult with your healthcare provider to find the right prenatal vitamin for you.`,
    benefits: "Mother and Baby",
